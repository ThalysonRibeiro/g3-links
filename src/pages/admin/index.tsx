...
export function Admin() {
  ...
  const [backgroundColorInput, setBackgroundColoeInput] = useState("#121212");
        ...
        <section className="flex my-4 gap-5">
          ...
          <div className="flex gap-2 items-center">
            ...
            <input type="color"
              ...
              onChange={(e) => setBackgroundColoeInput(e.target.value)}
            />
          </div>
        </section>
        {nameInput !== "" && (
          <div className="flex items-center justify-center flex-col mb-7 p-1 border-gray-100/25 border rounded-md">
            ...
            <article
              className="w-11/12 max-w-lg flex flex-col items-center justify-between border-r-zinc-900 rounded px-1 py-3"
